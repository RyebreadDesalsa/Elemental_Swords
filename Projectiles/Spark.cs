...
namespace Elemental_Swords.Projectiles
{
	public class Spark : ModProjectile
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Spark");     //The English name of the projectile
		...
		public virtual void CreateDust()
		{
				...
				int dust = Dust.NewDust(projectile.position, projectile.width, projectile.height, 226, 0f, 0f, 5, default(Color), 2f);
